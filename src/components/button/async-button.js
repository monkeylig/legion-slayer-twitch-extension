...
export default function AsyncButton({className='', style={}, onClick, children}) {
    ...
    return <Button className={`${stateClass} ${buttonStyle['rpg-button']} ${className}`} style={style} onClick={asyncOnClick}>{content}</Button>
}